...
def main():
    ...
    parser.add_argument(
        '--csv_file',
        type=str,
        default='code_repos_csv_0215.txt',
        help='Path to the CSV file with repo metadata'
    )
    parser.add_argument(
        '--repos_dir',
        type=str,
        default='/data/yubo/datasets/collected_sc_0215',
        help='Path to the directory containing downloaded repos'
    )
    parser.add_argument(
        '--output_path',
        type=str,
        default='extracted_python_files_0215.json',
...
if __name__ == "__main__":
    ...
    python step_2_extract_python_files_0215.py \
    --csv_file code_repo_csv_0215.txt \
    --repos_dir /data/yubo/datasets/collected_sc_0215 \
    --output_path /data/yubo/datasets/process_data_output_0215/extracted_python_files_0215.json
    '''
    main()