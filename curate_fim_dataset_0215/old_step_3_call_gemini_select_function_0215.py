...
def main():
    ...
    parser.add_argument(
        "--input", "-i",
        default="/data/yubo/datasets/process_data_output_0215/extracted_python_files_0215.json",
        help="Path to input JSON file"
    )
    parser.add_argument(
        "--output", "-o",
        default="/data/yubo/datasets/process_data_output_0215/step_3_selected_function_data_0216.json",
        help="Path to output JSON file"
    )
    parser.add_argument(
        "--checkpoint", "-c",
        default="/data/yubo/datasets/process_data_output_0215/step_3_checkpoint.json",
