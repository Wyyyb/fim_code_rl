#!/usr/bin/env python3
"""
下载 ubowang/fim_midtrain_data_0108_212k 数据集并保存为 JSONL 格式
"""
...
def main():
    print("正在下载数据集 ubowang/fim_midtrain_data_0108_212k ...")

    # 加载数据集
    dataset = load_dataset("ubowang/fim_midtrain_data_0108_212k")

    # 保存为 JSONL 格式
    output_file = "/data2/yubo/datasets/fim_midtrain_data_0108_212k/fim_midtrain_data_0108_212k.jsonl"
