...
Examples:
  ...
  python prepare_multi_sft_data.py -d /data/... \\
    ...
    parser.add_argument(
        "--checkpoint-dir", "-d",
        default="/data/yubo/datasets/process_data_output_0227/",
        help="Directory containing shard output files"
    )
    parser.add_argument(
        "--pairs-pattern",
        default="step_4_multi_fim_output_0227_shard*_of_*_pairs.json",
        help="Glob pattern for pair shard files"
    )
    parser.add_argument(
        "--triples-pattern",
        default="step_4_multi_fim_output_0227_shard*_of_*_triples.json",
        help="Glob pattern for triple shard files"
    )
    parser.add_argument(
        "--output-pairs",
        default="/data/yubo/datasets/hf_multi_functions_fim_sft_0227/multi_functions_fim_sft_pairs_0227.jsonl",
        help="Output JSONL for pair SFT data"
    )
    parser.add_argument(
        "--output-triples",
        default="/data/yubo/datasets/hf_multi_functions_fim_sft_0227/multi_functions_fim_sft_triples_0227.jsonl",
