...
inside table cells, and standard-deviation bands are reported in
parentheses where computed over three seeds. ``Baseline'' refers to the
base model followed by an agentic
