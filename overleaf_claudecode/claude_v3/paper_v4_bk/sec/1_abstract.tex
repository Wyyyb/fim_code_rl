...
post-training pipelines (R2E-Gym, SWE-Smith, SWE-Lego) without modification.
...
function-call inductive bias survives post-training and yields consistent
improvements over post-training alone.
\end{abstract}
