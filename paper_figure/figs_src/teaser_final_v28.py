...
gs = fig.add_gridspec(
    ...
    wspace=0.06,
    left=0.005, right=0.995, bottom=0.05, top=0.84,
)
...
fig.text(0.5, 0.955,
         ...
         fontsize=15.5, ha="center", va="center", fontweight="bold",
         color="#1a1a1a")
...
axM.text(0.5, 1.01, "Function-level FIM mid-training (SFT)",
         fontsize=11.5, fontweight="bold", ha="center", va="bottom")
...
# axR.set_ylabel("SWE-Bench resolved (%)", fontsize=12.0, labelpad=10)
axR.set_ylim(0, 45)
...
out = ROOT / "teaser_v29.pdf"
fig.savefig(out, bbox_inches="tight")
out_png = ROOT / "teaser_v29.png"
